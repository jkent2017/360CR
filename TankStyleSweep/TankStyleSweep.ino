...
{
  int power;
  SabertoothTXPinSerial.println("Starting...");
  SabertoothTXPinSerial.println("Backwards to Forwards");
  ...
  for (power = 127; power == 127; power-=10)
  {
    ST.drive(power);
    delay(50);
  }
  
  SabertoothTXPinSerial.println("Slow drive turn left then right");
